...
tarteaucitron.lang = {
    ...
    "alertBigPrivacy": "Мы используем куки-файлы, чтобы улучшить вашу работу в Интернете. Вы можете найти более подробную информацию в нашей %s",
    "alertSmall": "",
    "personalize": "Персонализировать",
    "acceptAll": "Принять",
    "close": "Закрыть",

    "privacyUrl": "Защита данных",
